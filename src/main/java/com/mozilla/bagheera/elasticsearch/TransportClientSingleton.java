...
public class TransportClientSingleton {
	...
	private TransportClientSingleton() {
	    client = new org.elasticsearch.client.transport.TransportClient(ImmutableSettings.settingsBuilder().put("client.transport.sniff", true));
	}
	...
	public static TransportClientSingleton getInstance() {
        if (INSTANCE == null) {
            INSTANCE = new TransportClientSingleton();
        }
