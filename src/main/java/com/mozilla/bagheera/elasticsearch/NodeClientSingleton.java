...
public class NodeClientSingleton {
    ...
    private NodeClientSingleton(Properties properties) {
        ...
        this.node = nodeBuilder().loadConfigSettings(true)
                .settings(ImmutableSettings.settingsBuilder().loadFromClasspath(configFile)).data(false).node().start();
    ...
    public NodeClientSingleton() throws IOException {
        ...
        this.node = nodeBuilder().loadConfigSettings(true)
                .settings(ImmutableSettings.settingsBuilder().loadFromClasspath(configFile)).node().start();
